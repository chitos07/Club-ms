...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Role::create(['role' => 'branche.index']);
        Role::create(['role' => 'branche.create']);
        Role::create(['role' => 'branche.edit']);
        Role::create(['role' => 'branche.show']);
        Role::create(['role' => 'branche.delete']);
        Role::create(['role' => 'branche.restore']);
